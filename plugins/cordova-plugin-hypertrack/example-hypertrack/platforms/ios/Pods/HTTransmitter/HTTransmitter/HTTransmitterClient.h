 ...
 *  @since  v0.10.0
 */
- (void)endTripWithCompletion:(HTTripBlock)completion NS_SWIFT_NAME(endTrip(completion:)) NS_UNAVAILABLE;
 ...
 *
 *  @see -startTaskWithTaskParams:completion:
 *
 *  @since  v0.5.0
 */
