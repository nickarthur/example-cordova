...
- (instancetype)initWithHost:(NSString *)host prefix:(NSString *)prefix userAgent:(NSString *)userAgent logger:(id<HTLoggerProtocol>)logger reachability:(HTReachability *)reachability NS_DESIGNATED_INITIALIZER;
