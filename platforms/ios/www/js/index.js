 ...
 */
 var app = {
    ...
    onDeviceReady: function() {
      ...
      cordova.plugins.HyperTrack.echo(
        'Plugin Ready!', 
        function(msg) { 
          document
      ...
      cordova.plugins.HyperTrack.echojs(
        'Hello Plugin',
        function(msg) {
      ...
      cordova.plugins.HyperTrack.getOrCreateUser(
        'cordova test', '+15103094946', '', '+15103094946',
        function(msg) { 
          console.log('user success-', msg)
          cordova.plugins.HyperTrack.stopTracking()
          cordova.plugins.HyperTrack.startTracking()
        },
        function(err) {
