...
- (NSDictionary *)dictionaryValue {
    ...
    [dictionary ht_setNilSafeObject:self.driverID forKey:idKey];
    [dictionary ht_setNilSafeObject:self.name forKey:nameKey];
    [dictionary ht_setNilSafeObject:self.phoneNumber forKey:phoneNumberKey];
    [dictionary ht_setNilSafeObject:self.photoURL.absoluteString forKey:photoKey];
    ...
    [dictionary ht_setNilSafeObject:self.lastKnownLocation.dictionaryValue forKey:lastKnownLocationKey];
