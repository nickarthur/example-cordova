...
static NSString * const timedEncodedPolylineKey = @"time_aware_polyline";
...
@property (copy, nonatomic, readwrite, nullable) NSString *timedEncodedPolyline;
...
- (void)updateWithResponseObject:(NSDictionary *)responseObject {
    ...
    self.timedEncodedPolyline = objc_dynamic_cast(NSString, responseObject[timedEncodedPolylineKey]);
...
- (NSDictionary *)dictionaryValue {
    ...
    [dictionary ht_setNilSafeObject:self.taskID forKey:taskIDKey];
    [dictionary ht_setNilSafeObject:self.orderID forKey:orderIDKey];
    [dictionary ht_setNilSafeObject:self.action forKey:actionKey];
    ...
    [dictionary ht_setNilSafeObject:self.initialETA.ht_stringValue forKey:initialETAKey];
    [dictionary ht_setNilSafeObject:self.committedETA.ht_stringValue forKey:committedETAKey];
    [dictionary ht_setNilSafeObject:self.startTime.ht_stringValue forKey:startTimeKey];
    [dictionary ht_setNilSafeObject:self.completionTime.ht_stringValue forKey:completionTimeKey];
    [dictionary ht_setNilSafeObject:self.driver.dictionaryValue forKey:driver];
    [dictionary ht_setNilSafeObject:self.startPlace.location.dictionaryValue forKey:startLocationKey];
    [dictionary ht_setNilSafeObject:self.destination.dictionaryValue forKey:destinationKey];
    [dictionary ht_setNilSafeObject:self.completionLocation.dictionaryValue forKey:completionLocationKey];
    ...
    [dictionary ht_setNilSafeObject:self.timedEncodedPolyline forKey:timedEncodedPolylineKey];
    [dictionary ht_setNilSafeObject:self.trackingURL forKey:trackingURLKey];
    [dictionary ht_setNilSafeObject:self.startAddress forKey:startAddressKey];
    [dictionary ht_setNilSafeObject:self.completionAddress forKey:completionAddressKey];
    [dictionary ht_setNilSafeObject:[HTVehicleType stringValueForVehicleType:self.vehicleType] forKey:vehicleTypeKey];
    [dictionary ht_setNilSafeObject:[HTConnectionStatus stringValueForConnectionStatus:self.connectionStatus] forKey:connectionStatusKey];
    [dictionary ht_setNilSafeObject:self.display.dictionaryValue forKey:displayKey];
...
- (void)updateWithTask:(HTTask *)task {
    ...
    self.timedEncodedPolyline = task.timedEncodedPolyline;
